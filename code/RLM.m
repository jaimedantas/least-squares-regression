...
for i = 1:30
    ...
    E(i) =  1/2 * 1/N * norm((X * polynomials_wi{i}) - t)^2;
end
...
% Polynomial Order 30 with i = 30
figure
hold on
p_w30_i30 = flip(polynomials_wi{30}');
fplot(poly2sym(p_w30_i30),[min(input) max(input)], 'LineWidth',2)
hold off

title('Polynomial of Order 30 and i = 30 and Dataset');
ylabel('t'); 
xlabel('x');
hold on
